...
public class Table {
    ...
    public void AddPlayer(){
        ...
        {
            case 0 : { 
                Player p = new Player(1,1,players.size());
                playField[1][1] = p;
                break;
            }
            case 1 : { 
                Player p = new Player(size-2,size-2,players.size());
                playField[size-2][size-2] = p;
                break;
            }
            case 2 : { 
                Player p = new Player(1,size-2,players.size());
                playField[1][size-2] = p;
                break;
            }
            case 3 : {  
                Player p = new Player(size-2,1,players.size());
